...
class AdminEditSubjectScreen extends StatefulWidget {
  const AdminEditSubjectScreen({super.key});

  @override
  State<AdminEditSubjectScreen> createState() =>
      _AdminEditSubjectScreenState();
}

class _AdminEditSubjectScreenState extends State<AdminEditSubjectScreen> {
  ...
  void initState() {
    ...
    nameController = TextEditingController(text: subjectName);
  }
  ...
  Future<void> _updateSubject() async {
    ...
    try {
      final request = UpdateSubjectRequest(subjectName: name);
